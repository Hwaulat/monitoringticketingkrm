      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Roof */}
            <path
              d="M75 148 C80 100 118 72 162 68 L228 68 C258 68 270 96 272 148Z"
              fill="url(#truckRoof)"
            />
            {/* Roof highlight stripe */}
            <path
              d="M95 148 C100 106 130 80 162 76 L200 76 C225 78 238 104 240 148Z"
              fill="white"
              opacity="0.06"
            />
            {/* A-pillar left */}
            <path
              d="M90 148 L114 78 L124 80 L98 148Z"
              fill="#1a3bb8"
              opacity="0.4"
            />
            {/* A-pillar right */}
            <path
              d="M230 148 L218 80 L228 78 L244 148Z"
              fill="#1a3bb8"
              opacity="0.3"
            />
            {/* Windshield */}
            <path
              d="M100 146 C105 104 130 80 162 76 L214 76 C240 80 248 108 250 146Z"
              fill="#a8c8f8"
              opacity="0.28"
            />
            <path
            ...
            <path
              d="M112 140 C116 108 132 86 152 82 L162 82 C148 88 135 110 130 140Z"
              fill="white"
              opacity="0.12"
            />
            {/* Windshield glare right */}
            <path
              d="M215 82 L228 84 C238 106 242 128 244 142 L230 144 C234 124 232 102 215 82Z"
              fill="white"
              opacity="0.06"
            />
            ...
            />
            <path
              d="M68 158 L76 158 L78 190 L68 190Z"
              fill="white"
              opacity="0.1"
            />
            {/* Right side window */}
            ...
            {[0, 1, 2, 3, 4].map((i) => {
              ...
              return (
                <circle
                  key={i}
                  cx={100 + 12 * Math.cos(a)}
                  cy={266 + 12 * Math.sin(a)}
                  r="2"
                  fill="#444"
                />
              )
            ...
            <path
              d="M289 175 Q290 168 296 166 L320 166 Q326 168 326 175 L328 228 L286 228Z"
              fill="url(#vestGrad)"
              rx="4"
            />
            {/* Vest collar */}
            <path
              d="M296 166 L308 178 L320 166"
              fill="none"
              stroke="#cc6600"
              strokeWidth="2"
            />
            ...
            {/* Vest shadow / depth */}
            <path
              d="M289 175 L286 228 L295 228 L296 175Z"
              fill="black"
              opacity="0.06"
            />
            ...
            {/* Hair */}
            <path
              d="M291 133 Q295 124 308 122 Q321 124 325 133 Q322 126 308 124 Q294 126 291 133Z"
              fill="#2a1a0a"
            />

            {/* Hard hat */}
            <path
              d="M288 132 Q290 118 308 114 Q326 118 328 132 Q322 126 308 124 Q294 126 288 132Z"
              fill="url(#helmetGrad)"
            />
            <rect x="285" y="131" width="46" height="6" rx="3" fill="#e08010" />
            <path
              d="M290 131 Q308 128 326 131"
              stroke="#ffd060"
              strokeWidth="1.5"
              fill="none"
              opacity="0.6"
            ...
            <rect
              ...
              rx="10"
              fill="white"
              style={{ filter: "drop-shadow(0 4px 12px rgba(22,163,74,0.25))" }}
            />
            <rect
              x="118"
              y="58"
